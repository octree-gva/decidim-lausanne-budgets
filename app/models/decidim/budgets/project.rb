...
module Decidim
  module Lausanne
    module Budgets
      # The data store for a Project in the Decidim::Lausanne::Budgets component. It stores a
      ...
      class Project < Budgets::ApplicationRecord
        ...
        belongs_to :budget, foreign_key: "decidim_lausanne_budgets_budget_id", class_name: "Decidim::Lausanne::Budgets::Budget", inverse_of: :projects
