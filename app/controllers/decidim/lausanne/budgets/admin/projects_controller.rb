        ...
        class ProjectsController < Admin::ApplicationController
          ...
          def create
            ...
            CreateProject.call(@form) do
              on(:ok) do
                flash[:notice] = I18n.t("projects.create.success", scope: "decidim.lausanne_budgets.admin")
                redirect_to lausanne_budget_projects_path(budget)
              end

              on(:invalid) do
                flash.now[:alert] = I18n.t("projects.create.invalid", scope: "decidim.lausanne_budgets.admin")
                render action: "new"
              end
            end
          end
          ...
          def destroy
            ...
            DestroyProject.call(project, current_user) do
              on(:ok) do
                flash[:notice] = I18n.t("projects.destroy.success", scope: "decidim.lausanne_budgets.admin")
                redirect_to lausanne_budget_projects_path(budget)
              end
            end
          end
