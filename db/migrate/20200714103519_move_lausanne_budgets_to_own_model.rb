...
class MoveLausanneBudgetsToOwnModel < ActiveRecord::Migration[5.2]
  ...
  class Order < ApplicationRecord
    self.table_name = :decidim_lausanne_budgets_orders
  end
  ...
  def budget_components
    @budget_components ||= Component.where(manifest_name: "lausanne_budgets")
  end
  ...
  def revert_budget_to_component(resource)
    component = Component.find_by(id: resource.decidim_component_id, manifest_name: "lausanne_budgets")
